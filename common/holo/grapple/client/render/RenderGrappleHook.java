...
public class RenderGrappleHook extends Render
{
     ...
     * work. In all probability, the class Render is generic (Render<T extends Entity) and this method has signature public void doRender(T entity, double d, double d1, double d2,
